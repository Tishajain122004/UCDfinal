      ...
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused, color, size }) => {
          ...
          if (route.name === "Home") {
            ...
            // This logic is currently unused since the screen is commented out below, but kept for completeness
            iconName = focused ? "shield" : "shield-outline"; 
          } else if (route.name === "More") {
            iconName = focused
              ? "ellipsis-horizontal-circle"
              : "ellipsis-horizontal-circle-outline";
          } else if (route.name === "ScreenStats") {
            // Logic added for the new ScreenStats tab
